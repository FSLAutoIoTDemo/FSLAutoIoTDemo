...
jQuery(document).ready(function(a) {
    var b = 55.748223, c = -4.16867;
    initalizeMaps(b, c), google.load("visualization", "1", {
        packages: [ "corechart" ],
        callback: initGraphs
    });
});

var map, currCenter, maxSpeed = 120, cssSppedPieSemiTransparent = "#004461", cssSppedPieFill = "#ffffff", dataPoints = 9, loopCount = dataPoints;